...
type Org struct {
	...
	D2LOrgID   string    `json:"d2l_org_id" gorm:"column:d2l_org_id;not null;uniqueIndex"`
	D2LBaseURL string    `json:"d2l_base_url" gorm:"column:d2l_base_url;not null;uniqueIndex"`
